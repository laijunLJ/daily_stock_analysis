...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TV_RATING_ENABLED": {
        "title": "TradingView TA Rating",
        "description": "Inject TradingView's multi-timeframe technical-analysis rating (Strong Buy..Strong Sell across weekly/daily/4h/1h) as an extra external technical reference signal in each stock's analysis prompt. Uses the public TradingView scanner (no login). US stocks resolve NASDAQ/NYSE/AMEX automatically. Fail-open: any fetch error is silently skipped and never blocks analysis.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 18,
        "help_key": "settings.data_source.tv_rating",
        "examples": [
            "TV_RATING_ENABLED=true",
            "TV_RATING_ENABLED=false",
        ],
        "docs": [],
        "warning_codes": [],
    },
